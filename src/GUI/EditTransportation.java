 ...
 * @author Jana
 */
public class EditTransportation extends JFrame {
    ...
    public EditTransportation(int index,  String carType, String ID, String Cost) {
        ...
        add(costField);
         ...
         saveButton.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                ...
                TransportationDashBoard.TransportationArrayList.set(index, updatedTransportation);
     ...
     public EditTransportation(int index, Transportation transportation){
     ...
     NameLabel.setBounds(50, 50, width, height);
      ...
      add(saveButton);
        saveButton.addActionListener(new EditTransportation.Action());
     }
