 ...
 * @author 2tech
 */
public class AddDJDashBoardGUI extends JFrame{
    ...
    private class Action implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) {
          DJ dfj=new DJ();
          dfj.setName(NameField.getText());
          dfj.setWebsite(WebsiteField.getText());
          dfj.setPhoneNumber(PhoneNumberField.getText());
          dfj.setID(IDField.getText());
          dfj.setDjSalary(Integer.parseInt(SalaryField.getText()));
          DJDashBoardGUI.DJArrayList.add(dfj);
          DJDashBoardGUI frdj = new DJDashBoardGUI();
          frdj.setVisible(true);
        }
    }
